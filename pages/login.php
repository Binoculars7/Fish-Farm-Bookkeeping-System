...
<head>
  ...
  <title>Sunday Emmmanuel Farms</title>
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row shadow">
              <div class="col-lg-6 d-none d-lg-block bg-login-image" style="background:url('fishfarm.jpeg'); box-shadow: 0 0 4px black;"></div>
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Sunday Emmanuel Farms<br> Management System!</h1>
                  </div>
