...
include'../includes/sidebar.php';
  ...
  $query = 'SELECT `ID`, `FNAME`, `FBAG`, `DATES` FROM `pondbudget` WHERE `ID` ='.$_GET['id'];
  $result = mysqli_query($db, $query) or die(mysqli_error($db));
...
?>
  ...
  <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
            ...
            <a  type="button" class="btn btn-primary bg-gradient-primary btn-block" href="attfb.php?"> <i class="fas fa-flip-horizontal fa-fw fa-share"></i> Back </a>
            <div class="card-body">
      
            <form role="form" method="post" action="attfb_edit1.php">
