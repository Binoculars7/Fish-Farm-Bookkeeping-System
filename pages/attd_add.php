  ...
  console.log($.getCities("Batangas")); 
          ...
          <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-primary">Add Pond Type</h4>
            </div>
            <a href="attd.php?action=add" type="button" class="btn btn-primary bg-gradient-primary">Back</a>
            <div class="card-body">
              <div class="table-responsive">
                        <form role="form" method="post" action="attd_transac.php?action=add">

              <div class="form-group">
                <input class="form-control" type="text" placeholder="Type Name" name="NAMES" required>
              </div>
              <div class="form-group">
